...
* ###### Deforestation | I love oak stairs. -> Gives 9 stacks of oak stairs to everyone.
* ###### Midas | iron = gold -> replaces the iron stuff you touch with gold.
* ###### Desiccated | Get wet -> gives poison until you put water at your feet.
* ###### Meteorite | Precious metal awaits inside -> netherite block with some obsidian around it. at 0, 0
* ###### Alchemy | Have you succeeded ? -> Gives random potion effect for 2 minutes. (except instant damage/heal/wither)
* ###### Bunny | On steroïds -> jump 256 for 1 minute
* ###### On fire | You're so hot right now -> Places fire at the player's feet for 2 minutes and fire resistance
* ###### Run | Or you'll have an explosive surprise -> summons a primed tnt at the player's feet every 2.5 sec for 1min
* ###### Taxes | 'Cuz Capitalism !! -> deletes a random slot of your inventory (any slot)
* ###### Random tp | The cards have been reshuffled -> spread players
* ###### Clang | Watch out! -> places an anvil above the player
* ###### Vote | for whoever you dislike most -> vote for a player, in 1min the most voted will get weakness 1 for 10min. can't be voted again
* ###### It's a trap | Watch your steps -> dripstone trap (8 hearts of damage no stuff)
* ###### Ghasts | but they're not so happy -> spawns ghasts
* ###### Chickens | but levitating -> spawns 6 levitating chickens on everyone that drop gapples
* ###### A vex ! | Where the fuck is it ?! -> spawns a vex leashed to each player
* ###### Get trapped | in obsidian -> spawns an obsidian box filled with water and black wool windows on each player
* ###### Chism | Make the other team disappear -> split the players in two teams. the last team standing wins
* ###### Baby creeper | A creeper but scarier -> spawns a baby creeper on everyone
* ###### Epic personality | You spiky little boy -> when a player is hurt, a cactus spawns randomly around him
* ###### One piece | Find the treasure where the lines cross -> treasure buried in the middle of the 4 structures
* ###### Nether leaked | at spawn. Fight it back ! -> puts nether biome at spawn
* ###### Swap | What is it gonna be next ? -> water buckets turn into lava 50% of the time
* ###### Crafting \[Poison] | poisons you. Avoid crafting. -> place a crafting table poisons you for 30 sec. (5 min)
* ###### Glowing | Y'all glow like stars, man ! -> gives glowing to everyone for 5 minutes
* ###### Love story \[Love] | Are you loved by someone ? -> binds the lives of two players. they will win or die together.
...
**Development:** *Titoufire26, Xorg78*

**Ideas, Testing, Bugfinding, Barbecue and jump-cheesing:** *Sowilgi*



I do what I want with version numbers ok ? Hipiti Hopiti this is now version 26-h.ok3.141596
