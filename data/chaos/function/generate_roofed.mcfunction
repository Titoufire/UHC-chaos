tellraw @s {"text":"//sel cyl", "clickEvent":{"action":"run_command","value":"//sel cyl"}}
tellraw @s {"text":"//pos1 0,63,0", "clickEvent":{"action":"run_command","value":"//pos1 0,63,0"}}
tellraw @s {"text":"//pos2 150,150,150", "clickEvent":{"action":"run_command","value":"//pos2 150,150,150"}}
tellraw @s {"text":"//replace ##logs air", "clickEvent":{"action":"run_command","value":"//replace ##logs air"}}
